...
# Remove existing packages (clean old versions)
...
# sed -i "s|kernel_path.*|kernel_path 'https://github.com/ophub/kernel'|g"
...
# Move v2ray-server to VPN menu (if needed)
